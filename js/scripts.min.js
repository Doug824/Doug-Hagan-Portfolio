!function(n) {
    n("html").removeClass("no-js"),n("header a").click(function(e) {
        if(!n(this).hasClass("no-scroll")) {
            e.preventDefault();let t=n(this).attr("href"),i=n(t).offset().top;
    ...
    n("#experience-timeline").each(function() {
        ...
        $this.find(".vtimeline-content").each(function() {
            let e=n(this).data("date");e&&n(this).parent().prepend('<span class="vtimeline-date">'+e+"</span>")
        })
    }),
